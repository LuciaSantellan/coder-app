const products = [
    ...
    {id: '2', name: 'Esmaltado semipermanente', price: 800, category: 'semipermanente', img:'https://media.glamour.mx/photos/632b2bbd8645b8d42bd2a909/master/w_1600%2Cc_limit/Tendencias-de-un%25CC%2583as-2023-21.jpeg', stock: 1000, description: 'Se coloca esmaltado sobre la uña natural, sin agregarle largo. Incluye manicura rusa combinada' }
    ,{id: '3', name: 'Kapping', price: 800, category: 'kapping', img:'https://media.glamour.mx/photos/632b1434bac8319e3c1d3ea9/1:1/w_1080,h_1080,c_limit/Tendencias-de-un%CC%83as-2023-4.jpeg', stock: 1000, description: 'Se coloca acrílico sobre la uña natural, sin agregarle largo. Incluye manicura rusa combinada.' }
]
